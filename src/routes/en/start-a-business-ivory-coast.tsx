...
const HOWTO_STEPS = [
  ...
  { name: "Pick and get your documents in 7–15 days", text: "Pick the firm that suits you. They handle RCCM, DFE, IDU, articles, CNPS and bank account." },
];
...
const FAQS = [
  ...
  { question: "What documents do I receive?", answer: "RCCM (trade register), DFE (tax existence declaration), IDU (unique identifier), articles of association, incorporation minutes, fiscal annex, CNPS certificate, and business bank account opening." },
...
export const Route = createFileRoute("/en/start-a-business-ivory-coast")({
  head: () =>
    buildPageHead({
      ...
      extraSchemas: [
        howToSchema("How to register a company in Côte d'Ivoire in 10 days", HOWTO_STEPS, {
