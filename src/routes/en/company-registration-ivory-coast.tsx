...
export const Route = createFileRoute("/en/company-registration-ivory-coast")({
  head: () =>
    buildPageHead({
      ...
      title:
        "Company Registration in Côte d'Ivoire | Find Your Accounting Firm | SoumissionComptable.com",
      description:
        "Register your SARL, SA or sole proprietorship in Côte d'Ivoire with a certified accounting firm. CEPICI steps, required documents, costs. Get 5 free quotes.",
      lang: "en",
