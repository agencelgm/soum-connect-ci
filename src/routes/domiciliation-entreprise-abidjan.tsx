        ...
        <div className="space-y-10">
          <section aria-labelledby="def">
            ...
            <p className="text-foreground leading-relaxed">
              La domiciliation consiste à attribuer à votre entreprise une adresse légale fournie
              par un prestataire agréé. Cette adresse devient le siège social officiel inscrit au
              RCCM et figure sur tous vos documents juridiques, commerciaux et fiscaux, sans
              nécessiter la location d'un local.
            </p>
          </section>
          ...
          <section aria-labelledby="why">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              {[
                {
                  icon: Globe2,
                  title: "Diaspora & expatriés",
                  desc: "Créer une entreprise en CI sans y résider physiquement.",
                },
                {
                  icon: Briefcase,
                  title: "Startups & freelances",
                  desc: "Image professionnelle sans charges de bureau fixe.",
                },
                {
                  icon: Building2,
                  title: "Adresse stratégique",
                  desc: "Quartier d'affaires reconnu (Plateau, Cocody).",
                },
              ].map((c) => (
          ...
          <section aria-labelledby="includes">
            ...
            <ul className="space-y-2 text-foreground">
              <li className="flex gap-3">
                <MapPin className="h-5 w-5 text-secondary shrink-0 mt-0.5" /> Adresse légale
                utilisable pour vos statuts et le RCCM
              </li>
              <li className="flex gap-3">
                <Mail className="h-5 w-5 text-secondary shrink-0 mt-0.5" /> Réception, tri et scan
                du courrier postal
              </li>
              <li className="flex gap-3">
                <Briefcase className="h-5 w-5 text-secondary shrink-0 mt-0.5" /> Accès ponctuel à
                des bureaux et salles de réunion
              </li>
              <li className="flex gap-3">
                <Building2 className="h-5 w-5 text-secondary shrink-0 mt-0.5" /> Justificatif de
                domiciliation accepté par le CEPICI
              </li>
            </ul>
          </section>
          ...
          <section aria-labelledby="price">
            ...
            <p className="text-foreground leading-relaxed">
              ...
              <strong>30 000 et 100 000 FCFA / mois</strong> selon le quartier et les services
              inclus.
            </p>
            <div className="mt-4 overflow-x-auto rounded-xl border border-border">
              <table className="w-full text-sm">
                ...
                <tbody className="divide-y divide-border">
                  <tr>
                    <td className="p-3 font-semibold">Plateau</td>
                    <td className="p-3">Premium / CBD</td>
                    <td className="p-3">70 000 – 100 000 FCFA</td>
                  </tr>
                  <tr>
                    <td className="p-3 font-semibold">Cocody</td>
                    <td className="p-3">Intermédiaire / standing</td>
                    <td className="p-3">50 000 – 80 000 FCFA</td>
                  </tr>
                  <tr>
                    <td className="p-3 font-semibold">Marcory / Yopougon</td>
                    <td className="p-3">Économique</td>
                    <td className="p-3">30 000 – 50 000 FCFA</td>
                  </tr>
                </tbody>
              </table>
            </div>
