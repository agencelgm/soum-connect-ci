  ...
  return (
    <>
      <ArticleCallout variant="info" title="En bref">
        <p>
          En Côte d&apos;Ivoire, l&apos;audit légal (commissariat aux comptes) devient
          obligatoire pour une SARL qui dépasse deux des trois seuils suivants :
          CA &gt; 500 millions FCFA, total du bilan &gt; 250 millions FCFA, ou plus
          de 50 salariés. Pour les SA, l&apos;audit légal est obligatoire dès la
          constitution. Un audit peut aussi être exigé par contrat ou par les
          statuts.
        </p>
      </ArticleCallout>
      ...
      <ArticleSection title="Quelle est la différence entre audit comptable et révision comptable ?">
        <p>
          <strong>La révision comptable</strong> est le travail quotidien du
          cabinet comptable : saisie, contrôle des pièces, production des états
          financiers et signature de la DSF. Mission obligatoire pour toute
          société.
        </p>
        <p>
          <strong>L&apos;audit comptable</strong> est une mission de vérification
          indépendante, réalisée par un expert-comptable habilité. L&apos;auditeur
          n&apos;est pas celui qui a tenu les comptes — son rôle est de certifier
          que les états financiers sont sincères et réguliers.
        </p>
      </ArticleSection>
      ...
      <ArticleSection title="Pour quelles entreprises l'audit légal est-il obligatoire en CI ?">
        ...
        <p>
          Audit obligatoire si <strong>deux des trois seuils</strong> sont
          dépassés à la clôture :
        </p>
        <ArticleTable
        ...
        />
        <p>
          Si la SARL dépasse deux seuils pendant deux exercices consécutifs,
          nomination d&apos;un commissaire aux comptes lors de la prochaine AGO.
        </p>
        <h3 className="font-heading font-semibold text-lg text-foreground mt-4">
          Les SA — dès la constitution
        </h3>
        <p>
          Pour une SA, le commissariat aux comptes est obligatoire dès la
          constitution. La SA doit nommer au moins un titulaire et un suppléant.
        </p>
        <h3 className="font-heading font-semibold text-lg text-foreground mt-4">
          Autres cas
        </h3>
      ...
      <ArticleSection title="Quel est le rôle exact du commissaire aux comptes ?">
        <p>
          Le CAC est inscrit à l&apos;OECCA-CI avec une habilitation spéciale. Son
          rôle dépasse la simple certification :
        </p>
        <ArticleList
          items={[
            <><strong>Mission principale</strong> — certifier que les comptes donnent une image fidèle.</>,
            <><strong>Missions permanentes</strong> — contrôle tout au long de l&apos;exercice.</>,
            <><strong>Mission d&apos;alerte</strong> — alerter le dirigeant en cas de risque sur la continuité d&apos;exploitation.</>,
            <><strong>Rapport annuel</strong> — certification sans réserve, avec réserves, ou refus de certification.</>,
          ]}
        />
      </ArticleSection>
      ...
      <ArticleSection title="Combien coûte un audit comptable en Côte d'Ivoire ?">
        ...
        />
        <p>
          Les Big Four (Deloitte, PwC, KPMG, EY) à Abidjan pratiquent des
          honoraires plus élevés que les cabinets locaux.
        </p>
      </ArticleSection>

      <ArticleSection title="Quelle est la différence entre audit légal et audit contractuel ?">
        <p>
          <strong>Audit légal</strong> — imposé par la loi (seuils OHADA ou
          forme SA). Mandat de 6 ans renouvelable.
        </p>
        <p>
          <strong>Audit contractuel</strong> — décidé volontairement ou exigé
          par un tiers. Peut être ponctuel ou récurrent. Utile pour les PME qui
          renforcent leur crédibilité bancaire ou préparent une levée de fonds.
        </p>
      </ArticleSection>
      ...
      <ArticleSection title="Questions fréquentes sur l'audit comptable en CI">
        <div className="space-y-6">
          ...
          <div>
            ...
            <p className="mt-2">
              Non. C&apos;est une incompatibilité fondamentale. L&apos;indépendance du
              CAC est un principe absolu.
            </p>
          </div>
          <div>
            <h3 className="font-heading font-semibold text-lg text-foreground">
            ...
            <p className="mt-2">
              Le CAC doit être inscrit à l&apos;OECCA-CI avec la mention
              « commissaire aux comptes ». Privilégiez une expérience dans
          ...
          <div>
            ...
            <p className="mt-2">
              Oui, et c&apos;est souvent conseillé. Un audit volontaire renforce la
              crédibilité auprès des investisseurs. Certains fonds l&apos;exigent
