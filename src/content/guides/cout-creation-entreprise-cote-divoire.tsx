    ...
    <>
      <ArticleCallout variant="info" title="En bref">
        <p>
          ...
          <strong>250 000 à 800 000 FCFA</strong> pour une SARL standard, hors capital social. Ce
          montant comprend les frais officiels CEPICI (50 000 à 150 000 FCFA), les honoraires du
          cabinet comptable (100 000 à 400 000 FCFA) et les frais annexes. Pour une SA, le budget
          monte à 2 000 000 à 5 000 000 FCFA en raison des honoraires de notaire.
        </p>
      </ArticleCallout>
      ...
      <ArticleSection title="Pourquoi le coût de création varie-t-il autant ?">
        ...
        <p>
          <strong>La forme juridique :</strong> une EI coûte moins cher qu&apos;une SARL, qui coûte
          beaucoup moins cher qu&apos;une SA. La SA requiert l&apos;intervention obligatoire
          d&apos;un notaire.
        </p>
        <p>
          <strong>Le prestataire choisi :</strong> les honoraires varient du simple au triple selon
          la taille, la réputation et la localisation du cabinet. Les prix très bas pratiqués par
          des prestataires non agréés sont risqués.
        </p>
        <p>
          <strong>Les options incluses :</strong> certains cabinets proposent un tarif « de base »,
          d&apos;autres un pack complet (domiciliation, accompagnement bancaire).
        </p>
      </ArticleSection>
      ...
      <ArticleSection title="Coût détaillé pour une SARL">
        ...
        />
        <p>
          <strong>Notre recommandation :</strong> ne choisissez pas uniquement sur le prix. Un
          cabinet non agréé ne peut pas signer la DSF.
        </p>
      </ArticleSection>

      <ArticleSection title="Coûts annexes à prévoir">
        <p>
          <strong>Domiciliation :</strong> 30 000 à 100 000 FCFA/mois selon le quartier. Prévoir 3
          mois minimum (90 000 à 300 000 FCFA).
        </p>
        <p>
          <strong>Ouverture de compte bancaire :</strong> 0 à 50 000 FCFA selon les banques.
        </p>
        <p>
      ...
      <ArticleSection title="Budget total pour une SARL">
        ...
        />
        <p>
          Pour une SARL classique avec accompagnement de qualité et domiciliation, prévoyez un
          budget d&apos;environ <strong>400 000 à 600 000 FCFA</strong> hors capital.
        </p>
      </ArticleSection>

      <ArticleSection title="Coût pour une entreprise individuelle (EI)">
        <p>
          L&apos;EI est la forme la moins coûteuse. Frais CEPICI : 30 000 à 60 000 FCFA. Honoraires
          de cabinet : 60 000 à 150 000 FCFA.
        </p>
        <p>
      ...
      <ArticleSection title="Coût pour une SA (Société Anonyme)">
        <p>La SA est beaucoup plus coûteuse en raison de :</p>
        ...
        <p>
          Budget total SA : <strong>2 000 000 – 5 700 000 FCFA hors capital social</strong>.
        </p>
      </ArticleSection>
      ...
      <ArticleSection title="Questions fréquentes">
        <div className="space-y-6">
          <div>
            ...
            <p className="mt-2">
              Non. Les frais officiels CEPICI sont incompressibles. Certains dispositifs
              d&apos;appui (FDFP, incubateurs) peuvent couvrir tout ou partie des frais pour les
              projets éligibles.
            </p>
          </div>
          <div>
            ...
            <p className="mt-2">
              Non. Le capital reste dans la société et finance l&apos;exploitation. Seuls les frais
              de création (CEPICI, cabinet, notaire) sont des coûts définitifs.
            </p>
          </div>
          <div>
            <h3 className="font-heading font-semibold text-lg text-foreground">
            ...
            <p className="mt-2">
              Non. Les frais officiels CEPICI sont réglés en une fois au dépôt du dossier. Les
              honoraires du cabinet peuvent parfois être négociés en deux versements.
            </p>
          </div>
        </div>
      </ArticleSection>
      ...
      <p className="mt-6 text-sm text-muted-foreground">
        Mis à jour en mai 2026. Sources : CEPICI, OECCA-CI, grilles tarifaires des cabinets
        partenaires.
      </p>
    </>
  );
