  ...
  return (
    <>
      <ArticleCallout variant="info" title="En bref">
        <p>
          La CNPS (Caisse Nationale de Prévoyance Sociale) est l&apos;organisme de sécurité sociale
          des travailleurs du secteur privé en Côte d&apos;Ivoire. Tout employeur doit s&apos;y
          immatriculer dès le premier salarié, déclarer et payer les cotisations mensuellement avant
          le 15 du mois suivant. Le taux de cotisation patronale tourne autour de 18,45 % de la
      ...
      <ArticleSection title="Qu'est-ce que la CNPS et pourquoi est-elle obligatoire ?">
        <p>
          La <strong>CNPS</strong> gère la protection sociale des travailleurs du secteur privé en
          Côte d&apos;Ivoire. Elle couvre trois branches :
        </p>
        <ArticleList
          items={[
        ...
        />
        <p>
          L&apos;affiliation est obligatoire dès le recrutement du premier salarié. Aucun seuil
          d&apos;effectif ne dispense l&apos;employeur.
        </p>
      </ArticleSection>

      <ArticleSection title="Comment s'immatriculer à la CNPS en tant qu'employeur ?">
        <p>
          L&apos;immatriculation se fait dans les <strong>8 jours</strong> suivant le recrutement du
          premier salarié. En pratique, elle est souvent intégrée au processus du guichet unique du
          CEPICI.
        </p>
        <p>
        ...
        />
        <p>
          L&apos;immatriculation donne un <strong>numéro d&apos;employeur CNPS</strong>. Chaque
          salarié reçoit également un numéro d&apos;immatriculation individuel.
        </p>
      </ArticleSection>
      ...
      <ArticleSection title="Quels sont les taux de cotisation CNPS en 2026 ?">
        ...
        />
        <p>
          <strong>Plafond :</strong> les cotisations s&apos;appliquent dans la limite d&apos;un
          plafond mensuel de <strong>1 647 315 FCFA</strong> par salarié en 2026.
        </p>
      </ArticleSection>
      ...
      <ArticleSection title="Comment calculer les cotisations CNPS d'un salarié ?">
        ...
        <ArticleList
          items={["Retraite : 500 000 × 6,30 % = 31 500 FCFA (déduite du salaire net)"]}
        />
        <p>
      ...
      <ArticleSection title="Comment déclarer et payer les cotisations CNPS ?">
        ...
        />
        <p>
          En fin d&apos;année, un <strong>état récapitulatif annuel (état 301)</strong> doit être
          déposé avant le <strong>31 janvier</strong>.
        </p>
      </ArticleSection>
      ...
      <ArticleSection title="Quelles sont les pénalités en cas de retard ou de non-déclaration ?">
        <ArticleList
          items={[
            ...
            <>
              En cas de fraude, pénalités pouvant atteindre <strong>le double</strong> des sommes
              éludées
            </>,
          ]}
        />
      ...
      <ArticleSection title="Quelles obligations l'employeur a-t-il envers ses salariés ?">
        ...
        <ArticleCallout variant="warning">
          <p>
            Un salarié non déclaré ne bénéficie d&apos;aucune protection. En cas d&apos;accident
            grave, l&apos;employeur est personnellement responsable des réparations.
          </p>
        </ArticleCallout>
      </ArticleSection>
      ...
      <ArticleSection title="Questions fréquentes sur la CNPS">
        <div className="space-y-6">
          <div>
            ...
            <p className="mt-2">
              Dès le <strong>premier salarié</strong>. Aucun seuil d&apos;effectif ne dispense
              l&apos;employeur, même à temps partiel.
            </p>
          </div>
          <div>
            <h3 className="font-heading font-semibold text-lg text-foreground">
            ...
            <p className="mt-2">
              Un gérant majoritaire (&gt; 50 % du capital) est non salarié et ne cotise pas. Un
              gérant minoritaire ou égalitaire peut être affilié s&apos;il est rémunéré avec un lien
              de subordination.
            </p>
          </div>
          <div>
            ...
            <p className="mt-2">
              Les stagiaires rémunérés au-delà d&apos;un certain seuil doivent être affiliés. Les
              stagiaires non rémunérés ne sont généralement pas soumis aux cotisations.
            </p>
          </div>
          <div>
            <h3 className="font-heading font-semibold text-lg text-foreground">
            ...
            <p className="mt-2">
              Oui, via une déclaration rectificative. Si la rectification entraîne un complément,
              les pénalités s&apos;appliquent à partir de la date initiale.
            </p>
          </div>
        </div>
      </ArticleSection>
      ...
      <p className="mt-6 text-sm text-muted-foreground">
        Mis à jour en mai 2026. Sources : Code du Travail ivoirien, CNPS Côte d&apos;Ivoire, taux de
        cotisation 2026.
      </p>
    </>
  );
