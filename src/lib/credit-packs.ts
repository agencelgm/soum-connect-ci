...
export type CreditPack = {
  ...
  label?: string;
  /** Prix promotionnel affiché aux partenaires ayant une promotion active. */
  promoPrice?: string;
  /** Produit Chariow à utiliser en promo (identique par défaut). */
...
export const CREDIT_PACKS: CreditPack[] = [
  ...
  { credits: 25, price: "25 000 FCFA", popular: true, productId: "prd_ak61x0fl", label: "Pro" },
  {
    credits: 0,
    price: "100 000 FCFA",
    promoPrice: "50 000 FCFA",
    popular: false,
    productId: "prd_mm3xnkwg",
    promoProductId: "prd_mm3xnkwg",
    unlimited: true,
    unlimitedDays: 30,
    label: "Illimité 30 jours",
  },
];
